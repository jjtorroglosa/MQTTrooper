...
func TestPublishDiscoveryEmitsButtonConfigPerService(test *testing.T) {
	...
	assert.Equal(t, "button.mqttrooper_test_alpha", payload["default_entity_id"])
...
func TestPublishDiscoveryEmitsNumberConfig(test *testing.T) {
	...
	case m := <-received:
		...
		assert.Equal(t, "number.mqttrooper_test_volume", payload["default_entity_id"])
...
func TestPublishDiscoveryEmitsSwitchConfig(test *testing.T) {
	...
	case m := <-received:
		...
		assert.Equal(t, "switch.mqttrooper_test_mute", payload["default_entity_id"])
